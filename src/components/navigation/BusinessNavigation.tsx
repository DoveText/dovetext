        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0">
            <Link href={user ? "/dashboard" : "/"} className="flex items-center">
              ...
              />
              <span className="ml-2 text-xl font-semibold text-gray-900">DoveText Business</span>
            </Link>
          </div>

          {/* Main Navigation - Business specific */}
          {user && (
            <div className="hidden md:flex items-center ml-10 space-x-10">
              ...
              <Link
                href="/assets"
                onClick={(e) => handleNavigation('/assets', e)}
                className="text-sm font-medium text-gray-900 hover:text-gray-700 flex items-center px-3 py-2 rounded-md hover:bg-gray-50"
              >
                    ...
                    <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="py-1">
                        <Menu.Item>
                          {({ active, close }) => (
                            <Link
                              href="/notifications/business"
                              onClick={(e) => handleNavigation('/notifications/business', e, close)}
                        ...
                        <Menu.Item>
                          {({ active, close }) => (
                            <Link
                              ...
                              onClick={(e) => handleNavigation('/notifications/settings', e, close)}
                              className={classNames(
                                active ? 'bg-gray-100' : '',
                                'block px-4 py-2 text-sm text-gray-700'
                              )}
