    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>We use cookies and similar tracking technologies to improve your experience and collect usage data. You can control cookie preferences through your browser settings.</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>We may update this Privacy Policy periodically. We will notify you of any material changes through our service or other means.</p>
        </section>

        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-4">10. Contact Us</h2>
          <p>For any questions about this Privacy Policy, please contact us at:</p>
          <p>Email: privacy@dovetext.com</p>
        </section>
      </div>
    </div>
  );
